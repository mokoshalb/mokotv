...
public class ActivityCommend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_submit_comment.setOnClickListener((View v)->validateAllField());

        (findViewById(R.id.bt_close)).setOnClickListener((View v)->{
                if (task_running) {
    ...
    private void submitCommentToApi() {
        ...
        client.post(Config.ADMIN_PANEL_URL +"/api/stream_commend/?api_key=" + Config.API_KEY, params, new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
            }
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if(reportResp){
                        ...
                        Toast.makeText(ActivityCommend.this, reportMsg, Toast.LENGTH_SHORT).show();
                    } else {
                        setEnableEditText(true);
