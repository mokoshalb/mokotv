...
public class ActivityReport extends AppCompatActivity{
    ...
    private void submitCommentToApi() {
        ...
        client.post(Config.ADMIN_PANEL_URL +"/api/stream_report/?api_key=" + Config.API_KEY, params, new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
                super.onStart();
            }
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    if(reportResp){
                        ...
                        Toast.makeText(ActivityReport.this, reportMsg, Toast.LENGTH_SHORT).show();
                    } else {
                        setEnableEditText(true);
