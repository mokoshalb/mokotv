...
public class VideoControlsLeanback extends VideoControls {
    ...
    public void setRewindButtonRemoved(boolean removed) {
        if (rewindButton != null) {
            rewindButton.setVisibility(removed ? GONE : VISIBLE);
        }
    }
    ...
    public void setFastForwardButtonRemoved(boolean removed) {
        if (fastForwardButton != null) {
            fastForwardButton.setVisibility(removed ? GONE : VISIBLE);
        }
    }
    ...
    protected void registerListeners() {
        ...
        rewindButton.setOnClickListener(v -> onRewindClick());
        fastForwardButton.setOnClickListener(v -> onFastForwardClick());
    ...
    public void showLoading(boolean initialLoad) {
        ...
        rippleIndicator.setVisibility(GONE);
    ...
    public void finishLoading() {
        ...
        rippleIndicator.setVisibility(VISIBLE);
    ...
    protected class ButtonFocusChangeListener implements OnFocusChangeListener {
        ...
        int getHorizontalDelta(View selectedView) {
    ...
    protected class RippleTranslateAnimation extends TranslateAnimation implements Animation.AnimationListener {
        static final long DURATION = 250;
